  ...
  return (
    <>
      <div style={S.card}>
        ...
        {item.image && <img src={item.image} alt="post" style={S.postImg} />}
  ...
  return (
    <div style={{ ...S.card, padding: 0, cursor: "pointer" }}
      ...
      <div style={{ padding: "12px 14px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
          <div style={{ cursor: "pointer" }} onClick={(e) => { e.stopPropagation(); if (item.authorUid) onAuthorTap(item.authorUid); }}>
            <Avatar
              ...
              plan={item.authorPlan || "trial"}
              role={item.authorRole || "participant"}
              size={36}
            />
          </div>
          <div>
        ...
        {item.summary && (
          <div style={{
            borderLeft: "3px solid #0D9488", background: "#F0FDFA",
            borderRadius: "0 8px 8px 0", padding: "8px 10px", margin: "8px 0",
          }}>
...
const S = {
  ...
  // Cards — now rounded with margin for card-in-feed look
  ...
  postImg:    { width: "100%", borderRadius: 10, objectFit: "cover", maxHeight: 260, display: "block" },
