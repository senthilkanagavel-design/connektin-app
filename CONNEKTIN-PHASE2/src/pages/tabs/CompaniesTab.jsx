      ...
      <div style={s.grid}>
        {companies.map(company => (
          <div key={company.id} style={s.card} onClick={() => navigate(`/company/${company.id}`)}>
            ...
            {/* Jobs count pill */}
            <div style={s.viewBtn}>View Profile →</div>
          </div>
        ))}
      </div>
    </div>
...
const s = {
  ...
  card:         { background: "#fff", borderRadius: 14, border: "0.5px solid #E4E2DC", padding: "16px 12px", display: "flex", flexDirection: "column", alignItems: "center", gap: 8, textAlign: "center", cursor: "pointer", transition: "box-shadow 0.15s", WebkitTapHighlightColor: "transparent" },
  ...
  viewBtn:      { fontSize: 11, fontWeight: 600, color: "#0D9488", marginTop: 2, fontFamily: "DM Sans, sans-serif" },
